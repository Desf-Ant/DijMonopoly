...
void MainWindow::initCases() {
    ...
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath + "Cases/depart.png")));
    this->cases[0]->setPos(997,717);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/vergy.png")));
    this->cases[1]->setPos(931,717);
    this->cases[1]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/gouv.png")));
    this->cases[2]->setPos(865,717);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/savoirs.png")));
    this->cases[3]->setPos(799,717);
    this->cases[3]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/impot.png")));
    this->cases[4]->setPos(733,717);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/arret1.png")));
    this->cases[5]->setPos(667,717);
    this->cases[5]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/dubois.png")));
    this->cases[6]->setPos(601,717);
    this->cases[6]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/chance.png")));
    this->cases[7]->setPos(535,717);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/marmuzots.png")));
    this->cases[8]->setPos(469,717);
    this->cases[8]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/vannerie.png")));
    this->cases[9]->setPos(403,717);
    this->cases[9]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/prison.png")));
    this->cases[10]->setPos(283,717);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/sully.png")));
    this->cases[11]->setPos(403,651);
    this->cases[11]->setRotation(90);
    this->cases[11]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/edf.png")));
    this->cases[12]->setPos(403,585);
    this->cases[12]->setRotation(90);
    this->cases[12]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/gabriel.png")));
    this->cases[13]->setPos(403,519);
    this->cases[13]->setRotation(90);
    this->cases[13]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/auxonne.png")));
    this->cases[14]->setPos(403,453);
    this->cases[14]->setRotation(90);
    this->cases[14]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/arret2.png")));
    this->cases[15]->setPos(403,387);
    this->cases[15]->setRotation(90);
    this->cases[15]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/berbisey.png")));
    this->cases[16]->setPos(403,321);
    this->cases[16]->setRotation(90);
    this->cases[16]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/charrue.png")));
    ...
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/zola.png")));
    this->cases[19]->setPos(403,123);
    this->cases[19]->setRotation(90);
    this->cases[19]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/parc.png")));
    this->cases[20]->setPos(283,3);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/cazotte.png")));
    ...
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/hugo.png")));
    this->cases[34]->setPos(997,387);
    this->cases[34]->setRotation(-90);
    this->cases[34]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/arret4.png")));
    ...
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/tremouille.png")));
    this->cases[37]->setPos(997,585);
    this->cases[37]->setRotation(-90);
    this->cases[37]->setFlag(QGraphicsItem::ItemIsSelectable, true);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/lafayette.png")));
    this->cases[38]->setPos(997,651);
    this->cases[38]->setRotation(-90);
    this->cases.push_back(this->scene->addPixmap(QPixmap(beginPath+"Cases/liberte.png")));
